  ...
  return (
    <button
      className={cn(
        ...
        // black background for both light and dark mode
        "bg-[linear-gradient(#444,#444),linear-gradient(#444_50%,rgba(68,68,68,0.6)_80%,rgba(68,68,68,0)),linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))]",
